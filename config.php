...
define('GOTEO_DB_SCHEMA', 'master');
define('GOTEO_DB_USERNAME', 'master');
define('GOTEO_DB_PASSWORD', '!ripper6177!');
...
define('SITE_URL', 'http://cs.birthvalley.com'); // endpoint url
define('SRC_URL', 'http://cs.birthvalley.com');  // host for statics
define('SEC_URL', 'http://cs.birthvalley.com');  // with SSL certified
