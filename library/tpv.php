    ...
    class Tpv {
        ...
        public static function pay($invest, &$errors = array()) {
			...
			try {
                ...
                echo '<html><head><title>WinnersFund</title></head><body><form action="'.$urlTPV.'" method="post" id="form_tpv" enctype="application/x-www-form-urlencoded">'.$data.'</form><script type="text/javascript">document.getElementById("form_tpv").submit();</script></body></html>';
                return true;
			}
			catch(Exception $ex) {
