    ...
    class Reward extends \Goteo\Core\Model {
        ...
        public function validate(&$errors = array()) {
            ...
            if (empty($this->project))
                $errors[] = 'There is no project to which to assign the reward / rettorno';
        ...
        public function save(&$errors = array()) {
            ...
            try {
                ...
                $errors[] = "The return {$this->reward} has not been recorded correctly. Please check the data." . $e->getMessage();
                return false;
            }
        }
